...
#SBATCH --mem=48000
#SBATCH -t 0-96:00:00
#SBATCH --output=./output/validate_runet.out
...
# For Batch
THEANO_FLAGS=device=gpu,exception_verbosity=high,floatX=float32 python -u validate.py
# For RC
#THEANO_FLAGS=device=gpu,exception_verbosity=high srun -p cox -n 1 -N 1 --mem=8000 -t 0-2:00:00 python -u train.py
